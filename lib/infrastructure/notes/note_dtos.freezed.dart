...
mixin _$NoteDTO {
  ...
  String get body;
  int get color;
  List<TodoItemDTO> get listOfTodo;
...
class _$NoteDTOCopyWithImpl<$Res> implements $NoteDTOCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      listOfTodo: listOfTodo == freezed
          ? _value.listOfTodo
          : listOfTodo as List<TodoItemDTO>,
...
class _$_NoteDTO extends _NoteDTO {
  ...
  final int color;
  @override
  final List<TodoItemDTO> listOfTodo;
  @override
  @ServerTimestampConverter()
  ...
  @override
  String toString() {
    return 'NoteDTO(id: $id, body: $body, color: $color, listOfTodo: $listOfTodo, serverTimeStamp: $serverTimeStamp)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _NoteDTO &&
            ...
            (identical(other.listOfTodo, listOfTodo) ||
                const DeepCollectionEquality()
                    .equals(other.listOfTodo, listOfTodo)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(listOfTodo) ^
...
// ignore: unused_element
  _TodoItemDTO call(
      {@required String id, @required String name, @required bool isDone}) {
    return _TodoItemDTO(
      id: id,
      name: name,
      isDone: isDone,
...
abstract class _TodoItemDTO extends TodoItemDTO {
  ...
  const factory _TodoItemDTO(
      ...
      @required bool isDone}) = _$_TodoItemDTO;
