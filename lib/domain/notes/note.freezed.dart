...
class _$_Note extends _Note {
  ...
  @override
  final List3<TodoItem> listOfTodo;

  @override
  String toString() {
    return 'Note(id: $id, body: $body, color: $color, listOfTodo: $listOfTodo)';
  }
...
abstract class _Note extends Note {
  ...
  const factory _Note(
      ...
      @required NoteBody body,
      @required NoteColor color,
      @required List3<TodoItem> listOfTodo}) = _$_Note;
