...
// ignore: unused_element
  _LoadSuccess loadSuccess(KtList<Note> listOfNotes) {
    return _LoadSuccess(
      listOfNotes,
    );
  }
...
mixin _$NoteWatcherState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result loadSuccess(KtList<Note> listOfNotes),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result loadSuccess(KtList<Note> listOfNotes),
...
abstract class _$LoadSuccessCopyWith<$Res> {
  ...
  $Res call({KtList<Note> listOfNotes});
}
...
class __$LoadSuccessCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object listOfNotes = freezed,
  }) {
    return _then(_LoadSuccess(
      listOfNotes == freezed ? _value.listOfNotes : listOfNotes as KtList<Note>,
    ));
  }
}
...
class _$_LoadSuccess implements _LoadSuccess {
  const _$_LoadSuccess(this.listOfNotes) : assert(listOfNotes != null);

  @override
  final KtList<Note> listOfNotes;

  @override
  String toString() {
    return 'NoteWatcherState.loadSuccess(listOfNotes: $listOfNotes)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _LoadSuccess &&
            (identical(other.listOfNotes, listOfNotes) ||
                const DeepCollectionEquality()
                    .equals(other.listOfNotes, listOfNotes)));
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(listOfNotes);
  ...
  Result when<Result extends Object>({
    ...
    assert(loadSuccess != null);
    assert(loadFailure != null);
    return loadSuccess(listOfNotes);
  }
...
abstract class _LoadSuccess implements NoteWatcherState {
  const factory _LoadSuccess(KtList<Note> listOfNotes) = _$_LoadSuccess;

  KtList<Note> get listOfNotes;
  _$LoadSuccessCopyWith<_LoadSuccess> get copyWith;
}
