...
// ignore: unused_element
  _TodoItemPrimitive call(
      {@required UniqueId id, @required String name, @required bool isDone}) {
...
abstract class $TodoItemPrimitiveCopyWith<$Res> {
  ...
  $Res call({UniqueId id, String name, bool isDone});
}
...
class _$_TodoItemPrimitive extends _TodoItemPrimitive {
  ...
  @override
  String toString() {
    return 'TodoItemPrimitive(id: $id, name: $name, isDone: $isDone)';
  }
...
abstract class _TodoItemPrimitive extends TodoItemPrimitive {
  ...
  const factory _TodoItemPrimitive(
      ...
      @required bool isDone}) = _$_TodoItemPrimitive;
